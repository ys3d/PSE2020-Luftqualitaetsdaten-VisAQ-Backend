...
public class DefaultInterpolationTest {
    ...
    public void ipTest() {
        ...
        ObservedProperty op = new ObservedProperty("saqn:op:mcpm10", "https://api.smartaq.net/v1.0/ObservedProperties('saqn%3Aop%3Amcpm10')"
                , false, "Mass concentration of Particulate Matter with a diameter of equal or less than 10 micrometers in air."
